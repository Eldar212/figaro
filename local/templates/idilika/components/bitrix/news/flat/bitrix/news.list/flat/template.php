...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	$previewImage = CFile::ResizeImageGet( $arItem["PREVIEW_PICTURE"], array( "width" => 350, 'height' => 350 ), BX_RESIZE_IMAGE_EXACT, true );
	...
	?>
	<div class="bx-newslist-container col-sm-6 col-md-4 news-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
				...
				<div class="bx-newslist-img">
					<?/*if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):*/?>
						<a href="<?/*=$arItem["DETAIL_PAGE_URL"]*/?>"><img
								src="<?/*=$arItem["PREVIEW_PICTURE"][0]["SRC"]*/?>"
								width="<?/*=$arItem["PREVIEW_PICTURE"][0]["WIDTH"]*/?>"
								height="<?/*=$arItem["PREVIEW_PICTURE"][0]["HEIGHT"]*/?>"
								alt="<?/*=$arItem["PREVIEW_PICTURE"][0]["ALT"]*/?>"
								title="<?/*=$arItem["PREVIEW_PICTURE"][0]["TITLE"]*/?>"
								/></a>
					<?/*else:*/?>
						<img
							src="<?/*=$arItem["PREVIEW_PICTURE"][0]["SRC"]*/?>"
