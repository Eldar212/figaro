...
?>
<div class="cat_list cat_list_search">
<?
if ($showTopPager)
{
	?>
...
<div class="flex catalog-section news-list bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
	<?
					...
					case 2:
						...
						<div class="col-xs-12 product-item-small-card">
							<div class="row">
								...
								{
									?>
									<div class="col-sm-4 product-item-big-card news-item">
										<div class="row">
											<div class="col-md-12">
												<?
												$APPLICATION->IncludeComponent(
