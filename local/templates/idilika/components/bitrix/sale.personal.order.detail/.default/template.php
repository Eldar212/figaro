...
<!--    <pre>--><?//print_r($arResult)?><!--</pre>-->
	<div class="container-fluid sale-order-detail flex">
        <div class="left_mnu_personal">
            <h3><?=$arResult['STATUS']['NAME']?></h3>
            <div class="flex mb12">
                <div>Дата заказа:</div>
                <div><strong><?=$arResult['DATE_INSERT_FORMATED']?></strong></div>
            </div>
            <div class="flex mb12">
                <div>Дата изменения статуса:</div>
                <div><strong><?=$arResult['DATE_UPDATE_FORMATED']?></strong></div>
            </div>
            <hr>
            ...
            <div>
                ...
                <?foreach ($arResult['ORDER_PROPS'] as $ORDERPROP) :?>
                    <?
                    switch ($ORDERPROP['CODE']) {
                        case "LOCATION":
                            echo $ORDERPROP['VALUE'];
                            break;
                        case "ADDRESS":
                            echo $ORDERPROP['VALUE'];
                            break;
            ...
            <div class="flex mb12">
                <div>Доставка</div>
                <div><?= $arResult['PRICE_DELIVERY_FORMATED'] ?></div>
            </div>
            <div class="flex all_paid">
                <div>Всего</div>
                <div><?= $arResult['SUM_PAID_FORMATED']?></div>
            </div>
        </div>
        <div class="right_personal">
            ...
            <div class="order_det">
                ...
                <div class="flex tr_det">
                    <div class="td_img"><img src="<?=$basket['PICTURE']['SRC']?>" alt=""></div>
                    <div class="td_name">
                        <a href="<?=$basket['DETAIL_PAGE_URL']?>" class="name mb12"><?=$basket['NAME']?></a>
                        <?foreach ($basket['PROPS'] as $PROP) :?>
                            <?
                            switch ($PROP['CODE']) {
                                case "COLOR_REF":
                                    echo "<span>".$PROP['VALUE']."</span>";
                                    break;
                                case "SIZES_CLOTHES":
                                    echo "<span>".$PROP['VALUE']."</span>";
                                    break;
                    ...
                    <div class="td_price"><?=$basket['FORMATED_SUM']?></div>
                </div>
                <?endforeach;?>
            </div>
        </div>
