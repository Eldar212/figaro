...
<div class="flex head_breadcrumb">
...
<div>
	<? if ( $isFilter || $isSidebar ): ?>
        <div class="col-md-3 col-sm-4 <?= ( isset( $arParams['FILTER_HIDE_ON_MOBILE'] ) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '' ) ?>"> <? // col-sm-push-8 col-md-push-9 ?>
			<? if ( $isFilter ): ?>
                ...
                <div class="filter-open inmobile">
                    <button class="btn-white filter-open--button popup-toggle" data-popup-name="filter">Фильтр</button>
                </div>

                <div class="popup popup-filter" data-popup-name="filter">
                    <div class="popup-wrapper">
                        <div class="popup-content">
                            <button class="popup-close"></button>
                            <div class="mobile-smartfilter"></div>
                        </div>
                    </div>
                </div>
			<? endif ?>
	...
	<? endif ?>
    <div class="<?= ( ( $isFilter || $isSidebar ) ? "col-md-9 col-sm-8" : "col-xs-12" ) ?>"> <? // col-sm-pull-4 col-md-pull-3 ?>
        <div class="row row-catalog-mobile">
            ...
            <div>
                ...
                if (false) { // Отключение вывода списка категорий в каталоге
	                $APPLICATION->IncludeComponent(
