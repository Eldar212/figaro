...
<div class='row'>
	<div class='<?=($isSidebar ? 'col-md-9 col-sm-8' : 'col-xs-12')?>'>
        ...
        <div class="row head_breadcrumb without_h1 breadcrumb-product-page">
            <div class="col-md-12">
                <div id="navigation">
					<?
		...
		if ($elementId > 0)
		{
			...
			if (!empty($recommendedData))
			{
				...
				if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N')
				{
					?>
					<div class='row'>
						<div class='col-xs-12 slider-can-like' data-entity="parent-container">
							<div class="catalog-block-header" data-entity="header" data-showed="false" style="display: none; opacity: 0;">
                                Вам также может понравиться <? // =GetMessage('CATALOG_POPULAR_IN_SECTION')?>
							</div>
							<?
							$APPLICATION->IncludeComponent(
