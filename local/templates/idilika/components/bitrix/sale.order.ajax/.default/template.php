                        ...
                        <div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
                            <div class="bx-soa-section-title-container">
                                <h2 class="bx-soa-section-title col-sm-9">
                                    ...
                                    <button class="checkout-toggle"></button>
                                </h2>
                            </div>
                            <div class="bx-soa-section-content container-fluid"></div>
                        </div>
                ...
                <div id="bx-soa-total" class="col-sm-4 bx-soa-sidebar">
                    ...
                    <div class="bx-soa-cart-total-wrapper">
                        ...
                        <div id="bx-soa-orderSave">
                            ...
                            <div class="order_btn_flex">
                                <a href="javascript:void(0)" style="display: block; width: 100%" data-save-button="true">
                                    <button class="btn-black btn-checkout"><?= $arParams['MESS_ORDER'] ?></button>
                                </a>
                            </div>
